...
const Assignments: React.FC = () => {
  ...
  const [assignments, setAssignments] = useState(assignmentstatic);
  ...
  const filteredAssignments = assignments.filter((assignment) => {
    ...
    const matchesCourse =
      courseFilter === "all" || assignment.courseCode === courseFilter;
  ...
  const handleFileUpload = (assignmentId: number) => {
    if (selectedFile) {
      console.log(
        `Uploading file for assignment ${assignmentId}:`,
        selectedFile.name
      );
            ...
            >
              <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                ...
                <div className="lg:col-span-2">
                  <div className="flex items-start justify-between mb-4">
                    <div className="flex-1">
                      ...
                      <div className="flex items-center space-x-2 mb-3">
                        ...
                        {assignment.grade !== null && viewMode == "student" && (
                  ...
                  {assignment.feedback && viewMode == "student" && (
                ...
                <div className="space-y-6">
                  <div>
                    ...
                    <div className="space-y-3">
                      ...
                      {assignment.submittedDate && viewMode == "student" && (
                        <div className="flex items-center space-x-2">
