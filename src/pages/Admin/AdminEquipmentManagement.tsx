...
export default function AdminEquipmentManagement() {
    ...
    try {
      ...
      if (editingEquipment) {
        await equipmentService.updateEquipment(
          editingEquipment.id,
          formData as EquipmentUpdateInput
        );
  ...
  const handleHandoverRequest = async (id: number) => {
    if (
      !confirm("Confirm that equipment has been handed over to the requester?")
    )
      return;
  ...
  const handleReturnEquipment = async (id: number) => {
    if (!confirm("Confirm that equipment has been returned by the requester?"))
      return;
            ...
            <TabsContent value="requests" className="space-y-6">
              ...
              <div className="flex gap-2 flex-wrap">
                ...
                <Button
                  ...
                  onClick={() =>
                    navigate(
                      "/admin/equipment-management?tab=requests&filter=approved"
                    )
                  }
                >
                  Approved (
                ...
                <Button
                  ...
                  onClick={() =>
                    navigate(
                      "/admin/equipment-management?tab=requests&filter=handover"
                    )
                  }
                >
                  Handed Over (
                  {requests.filter((r) => r.status === "handover").length})
                </Button>
                <Button
                  ...
                  onClick={() =>
                    navigate(
                      "/admin/equipment-management?tab=requests&filter=completed"
                    )
                  }
                >
                  Completed (
                ...
                <Button
                  ...
                  onClick={() =>
                    navigate(
                      "/admin/equipment-management?tab=requests&filter=rejected"
                    )
                  }
                >
                  Rejected (
                ...
                <Button
                  ...
                  onClick={() =>
                    navigate(
                      "/admin/equipment-management?tab=requests&filter=cancelled"
                    )
                  }
                >
                  Cancelled (
                          ...
                          {request.status === "approved" && (
                            <>
                              <Button
                                size="sm"
                                onClick={() =>
                                  handleHandoverRequest(request.id)
                                }
                                className="bg-blue-600 hover:bg-blue-700"
                              >
                  ...
                  <Card>
                    <CardContent className="p-12 text-center">
                      ...
                      <p className="text-gray-400 text-sm mt-2">
                        Requests will appear here when submitted by users.
                      </p>
                    </CardContent>
                  </Card>
                )}
