...
import { adminService, type ProgramCreateRequest, type ProgramUpdateRequest } from "../../services/adminService";
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-gray-600 mt-1">Manage academic programs and degree requirements</p>
            </div>
            <button
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        {filteredPrograms.length === 0 && (
          <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-12 text-center">
            ...
            <p className="text-gray-500">Get started by creating your first academic program.</p>
          </div>
        )}
      </div>
